...
- [x] Define independent temporal domain and deterministic fixture.
- [x] Define the narrow feature-store application port.
- [x] Implement fake-port substitutability tests.
- [x] Implement Feast Parquet/local-registry/SQLite adapter.
- [x] Register a named model-facing FeatureService.
- [x] Prove future-leak and TTL behavior.
- [x] Prove offline-to-online value consistency.
